...
public class EventHubsExporterIntegrationTest extends MonitorExporterClientTestBase {
  ...
  // @Disabled(
  //    "Processor integration tests require separate consumer group to not have partition
  // contention in CI - https://github.com/Azure/azure-sdk-for-java/issues/23567")
  @Test
  public void processorTest() throws InterruptedException {
    ...
    assertTrue(eventCountDown.await(20, TimeUnit.SECONDS));
